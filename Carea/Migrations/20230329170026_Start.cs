        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Car_Desc = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Car_Price = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Car_Photo_Color", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Car_Photo_Color_Cars_Car_Id",
                        column: x => x.Car_Id,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Car_Rate", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Car_Rate_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Car_Photo_Color_Car_Id",
                table: "Car_Photo_Color",
                column: "Car_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Car_Rate_CarId",
                table: "Car_Rate",
                column: "CarId");
